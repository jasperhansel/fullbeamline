!+
! Program ptc_spin_orbital_hamiltonian_tracking
!
...
!    ptc_spin_orbital_hamiltonian_tracking.pdf
!-
...
end program ptc_spin_orbital_hamiltonian_tracking
