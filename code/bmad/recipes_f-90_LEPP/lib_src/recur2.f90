	...
	INTEGER(I4B) :: n
	REAL(dp), DIMENSION(size(a)-1) :: a1,a2,u1,u2
	REAL(dp), DIMENSION(size(a)-2) :: b11,b12,b21,b22
...
!BL
	...
	USE nrtype; USE nrutil, ONLY : assert_eq
	IMPLICIT NONE
	REAL(dp), DIMENSION(:), INTENT(IN) :: a1,a2,b11,b12,b21,b22
	REAL(dp), DIMENSION(:), INTENT(OUT) :: u1,u2
	INTEGER(I4B), PARAMETER :: NPAR_RECUR2=8
	INTEGER(I4B) :: n,j,nn,nn1
	REAL(dp), DIMENSION(size(a1)/2) :: aa1,aa2
	REAL(dp), DIMENSION(size(a1)/2-1) :: bb11,bb12,bb21,bb22
