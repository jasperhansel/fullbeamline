...
$ LIBRARY/CREATE=(BLOCKS:200)/LOG TEMPX.OLB 
$!
...
$   COPY/CONCAT 'SRC'*.F TEMPX.FOR
$   FCOMPILE TEMPX/NODEBUG
$   LIBRARY/REPLACE TEMPX TEMPX
$   DELETE TEMPX.OBJ;*,TEMPX.FOR;*
$ WSO "Compiling VMS-specific routines"
$   COPY/CONCAT 'VMS'*.F TEMPX.FOR
$   FCOMPILE TEMPX/NODEBUG
$   LIBRARY/REPLACE TEMPX TEMPX
$   DELETE TEMPX.OBJ;*,TEMPX.FOR;*
$CLOOP:
...
$     LIBRARY/REPLACE TEMPX 'FILEX'.OBJ
$     DELETE 'FILEX'.OBJ;*
$   GOTO CLOOP
$ENDCLOOP:
