...
C
      USE XSIF_INOUT
      use xsif_lat_file_names_mod ! Added: DCS 2006/2/28
...
c Init the file name stack   

      call file_name_list_init ()  ! Added: DCS 2006/2/28
...
C		IF ( ERR_LCL .NE. 0 ) THEN
     ...
     &				DECKFILE
		...
		call file_name_list_add (deckfile) ! Added: DCS 2006/2/28
