...
C	initial values
	...
	PARAMETER ( PI_INIT =      3.1415926535898D0 ,
     ...
     &			CLIGHT_INIT =  2.99792458D+08      )
      ...
      REAL*8 :: CRDEG = 1/degrad_init ! conversion radians to degrees
      REAL*8 :: CLIGHT = clight_init  ! speed of light
      REAL*8    CMAGEN                ! convert GeV to kGm
      REAL*8 :: EMASS = emass_init
      real*8 ERAD, ECHG                ! electron mass, radius, and
